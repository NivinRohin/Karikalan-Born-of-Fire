...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      ...
      // Using a standard for loop instead of .forEach in this high-frequency render loop
      // to avoid allocating inline callback functions every frame, reducing GC pressure.
