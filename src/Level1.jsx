...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      ...
      // ⚡ Bolt: Use a standard for-loop instead of .forEach in the render loop.
      // This prevents allocating a new inline callback function on every frame,
      // reducing Garbage Collection (GC) pressure and preventing micro-stutters.
