...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      ...
      // ⚡ Bolt: Replaced .forEach with a standard for loop to prevent allocating
      // a new inline callback function on every frame, reducing Garbage Collection (GC) pressure.
