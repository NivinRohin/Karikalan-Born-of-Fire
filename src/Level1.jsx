...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      ...
      // Optimization: Using a standard for loop instead of .forEach inside a render loop
      // to prevent allocating new inline callback functions on every frame, reducing GC pressure.
