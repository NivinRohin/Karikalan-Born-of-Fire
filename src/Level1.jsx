...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      // Performance optimization: use standard for-loop instead of .forEach
      // to avoid allocating inline callback functions on every frame,
      // reducing Garbage Collection (GC) pressure and micro-stutters.
