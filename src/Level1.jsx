...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      ...
      // ⚡ Bolt: Using a standard for loop instead of .forEach in this hot useFrame loop to prevent allocating a new callback function every frame, reducing GC pressure.
