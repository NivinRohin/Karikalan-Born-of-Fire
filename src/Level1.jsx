...
// Cache for geometries and materials to reduce memory allocations
const geometryCache = new Map();
const materialCache = new Map();

// Pre-allocate FirePit geometry and materials
...
const Block = ({ position, color = "#4a4a4a", isObstacle = true, isFloor = true, args = [1, 1, 1] }) => {
  // Use cached geometry or create a new one
  ...
  // Use cached material or create a new one
...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      ...
      // Use standard for loop to reduce GC pressure compared to forEach
