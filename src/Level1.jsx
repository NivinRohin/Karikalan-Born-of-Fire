...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      // ⚡ Bolt: Using a standard for loop instead of .forEach in the render loop reduces Garbage Collection pressure and function call overhead, ensuring a smoother frame rate.
