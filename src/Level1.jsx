...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      ...
      // ⚡ Bolt: Use a standard for loop instead of .forEach in the high-frequency render loop
      // to prevent allocating a new inline callback function on every frame,
      // significantly reducing Garbage Collection (GC) pressure and micro-stutters.
