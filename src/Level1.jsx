...
// Pre-allocate geometry and materials outside the render loop
...
const FirePit = ({ startX, endX, y, z }) => {
  ...
  useFrame(({ clock }) => {
    ...
    if (fireGroupRef.current) {
      ...
      // Use standard for loop instead of .forEach() to prevent closure allocations every frame
  ...
  // 0.5 is a power of 2 (2^-1), so there is no floating-point precision drift.
