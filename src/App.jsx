...
function App() {
  return (
    <Canvas
      ...
      tabIndex={0}
      aria-label="Retro 2.5D side-scrolling platformer level"
      className="focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#ff6600] focus-visible:ring-inset"
    >
      {/*
