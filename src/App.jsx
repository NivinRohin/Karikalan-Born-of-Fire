...
function App() {
  return (
    <Canvas style={{ width: '100vw', height: '100vh', background: '#050505' }} aria-label="3D Game Level" tabIndex={0} className="focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#ff6600]">
      {/*
