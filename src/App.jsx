...
function App() {
  return (
    <Canvas
      aria-label="2.5D side-scrolling perspective scene"
      tabIndex={0}
      className="focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-inset focus-visible:ring-orange-500"
