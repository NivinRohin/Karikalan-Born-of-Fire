...
function App() {
  return (
    <Canvas aria-label="3D Game Level" tabIndex={0} className="focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-500" style={{ width: '100vw', height: '100vh', background: '#050505' }}>
      {/*
