...
function App() {
  return (
    <Canvas
      ...
      aria-label="Interactive 3D level environment"
      tabIndex={0}
      className="focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-inset focus-visible:ring-blue-500"
    >
      {/*
