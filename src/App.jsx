...
function App() {
  return (
    <Canvas
      ...
      aria-label="Karikalan: Born of Fire game scene"
      tabIndex={0}
      className="focus-visible:ring-4 focus-visible:ring-inset focus-visible:ring-orange-500 focus-visible:outline-none"
    >
      {/*
