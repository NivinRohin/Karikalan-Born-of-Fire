...
function App() {
  return (
    <Canvas style={{ width: '100vw', height: '100vh', background: '#050505' }} tabIndex={0} aria-label="Interactive 3D Level" className="focus-visible:ring-4 focus-visible:ring-white focus-visible:outline-none">
      {/*
