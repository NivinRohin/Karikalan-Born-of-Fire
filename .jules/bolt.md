## 2026-06-13 - Prevent GC micro-stutters in R3F useFrame
...
**Action:** Use standard `for` loops inside `useFrame` and other high-frequency loops to prevent unnecessary object allocation.
