## 2026-06-04 - Avoid array iteration methods in useFrame
...
**Action:** Use standard `for` loops instead to prevent unnecessary object allocation and eliminate GC stutters.
